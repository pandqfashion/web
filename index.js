...
let foodMenuList = document.querySelector('.store-item-wrap')

let foodCategory = document.querySelector('.fashion-category')
...
Array.from(categories).forEach((item, index) => {
    item.onclick = (e) => {
        ...
        foodMenuList.classList ='store-item-wrap '+ e.target.getAttribute('data-item-type')
    }
})
